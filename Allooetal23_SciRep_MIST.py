...
os.chdir(r'') # Put the directory where the 'Wattle Flower' data is here
num_masks = 15
...
DFphiim = Image.fromarray(lap_phiDF).save(
    'LapDFPhiphase_{}.tif'.format('mask' + str(num_masks) + 'e' + str(alpha))) # Saving solutions of the system of linear equations
...
print('TRUE phase-object approximation dark-field computed')

# Calculating the phase-shifts and attenuation term
ref = Ir[1, :, :]
sam = Is[1, :, :]
...
e = 0.0001  # This regularises the inverse Fourier transform around the origin of Fourier space (may need tweaking)
